...
class ApiService {
    ...
    func getProductById(id: Int, completition: @escaping (Result<ProductViewController.ExternalProduct, Error>)-> Void ){
        ...
        dataTask = URLSession.shared.dataTask(with: url) {
            ...
            do{
                ...
                let jsonData = try decoder.decode(ProductViewController.ExternalProduct.self, from: data)
